...
val nuvyraPackageName = "com.nuvyra.launcher"
...
android {
    ...
    defaultConfig {
        applicationId = nuvyraPackageName
        minSdk = 26
        targetSdk = 34
