...
-keep class com.nuvyra.launcher.bridge.** { *; }
-keep class com.nuvyra.launcher.utils.device.VulkanChecker {
    *;
}
-keep class com.nuvyra.launcher.utils.device.VulkanCapabilities {
    *;
}
-keep interface com.nuvyra.launcher.utils.device.VulkanLogCallback {
    *;
}
-keep class com.nuvyra.launcher.game.input.CriticalNativeTest {
    *;
}
