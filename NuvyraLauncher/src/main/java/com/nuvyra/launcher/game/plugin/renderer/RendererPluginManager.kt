...
package com.nuvyra.launcher.game.plugin.renderer
...
import com.nuvyra.launcher.game.plugin.renderer_v2.RendererV2PluginManager
import com.nuvyra.launcher.game.renderer.Renderers

/**
 * FCL、NuvyraLauncher 渲染器插件，同时支持使用本地渲染器插件
