...
import com.nuvyra.launcher.utils.file.check7z
import com.nuvyra.launcher.utils.file.checkZip
 ...
 * 一个待下载文件的完整描述
 * 候选源、目标位置与校验方式
 * 批量执行交给 [BatchDownloader]，单个文件也可以通过 [com.nuvyra.launcher.game.download.engine.DownloadEngine] 直接驱动
 */
class DownloadTask(
