/*
 * 来源：FoldCraftLauncher PR #1821（FCL/src/main/jni/flite/flite_bridge.c，GPL-3.0）
...
#define LOG_TAG "ZL-flite"
#define LOGW(...) __android_log_print(ANDROID_LOG_WARN, LOG_TAG, __VA_ARGS__)

static const char *BRIDGE_CLASS = "com.nuvyra.launcher.bridge.FliteTts";
