...
JNIEXPORT void JNICALL
Java_com_nuvyra_launcher_game_sdl_SdlBridge_initializeControllerSubsystems(__attribute__((unused)) JNIEnv* env, __attribute__((unused)) jclass clazz) {
...
static bool tryCriticalNative(JNIEnv *env) {
    ...
    jclass criticalNativeTest = (*env)->FindClass(env, "com/nuvyra/launcher/game/input/CriticalNativeTest");
