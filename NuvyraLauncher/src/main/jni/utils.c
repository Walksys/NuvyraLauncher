...
JNIEXPORT void JNICALL Java_com_nuvyra_launcher_bridge_ZLBridge_setLdLibraryPath(JNIEnv *env, jclass clazz, jstring ldLibraryPath) {
...
JNIEXPORT jboolean JNICALL Java_com_nuvyra_launcher_bridge_ZLBridge_dlopen(JNIEnv *env, jclass clazz, jstring name) {
...
JNIEXPORT jlong JNICALL Java_com_nuvyra_launcher_bridge_ZLBridge_getJavaVMPointer(JNIEnv *env, jclass clazz) {
	if (pojav_environ->dalvikJavaVMPtr == NULL) return 0;
	return (jlong) (intptr_t) pojav_environ->dalvikJavaVMPtr;
}

JNIEXPORT jstring JNICALL Java_com_nuvyra_launcher_bridge_ZLBridge_jObjectToString(JNIEnv *env, jclass clazz, jobject object) {
...
JNIEXPORT jint JNICALL Java_com_nuvyra_launcher_bridge_ZLBridge_chdir(JNIEnv *env, jclass clazz, jstring nameStr) {
