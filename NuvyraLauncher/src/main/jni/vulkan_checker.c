...
Java_com_nuvyra_launcher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_nuvyra_launcher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
    ...
    VkApplicationInfo appInfo = {
            ...
            .pApplicationName = "NuvyraLauncher",
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/nuvyra/launcher/utils/device/VulkanCapabilities");
